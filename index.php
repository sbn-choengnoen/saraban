          ...
          <tr>
            ...
            <td class="text-center">
              <?php if (!empty($b['attachment'])): ?>
                ...
                <?php if ($ext === 'pdf'): ?>
                  <a href="<?= sanitize(str_replace('/image/upload/', '/image/upload/', $b['attachment'])) ?>" target="_blank" class="btn btn-outline-danger btn-action" title="เปิด PDF">
                    <i class="bi bi-file-earmark-pdf"></i>
                  </a>
                <?php else: ?>
                  <a href="<?= sanitize($b['attachment']) ?>" target="_blank" class="btn btn-outline-success btn-action" title="ดูรูปภาพ">
        ...
        <div class="modal-body">
          <div class="row g-3">
            <div class="col-md-6">
              ...
              <input type="text" name="book_ref" id="fBookRef" class="form-control" placeholder="เช่น รย 0118/ว 5442">
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <input type="text" name="from_org" id="fFromOrg" class="form-control" placeholder="ชื่อหน่วยงานผู้ส่ง" required>
            </div>
            <div class="col-md-6">
              <label class="form-label">ถึง (หน่วยงานผู้รับ)</label>
              <input type="text" name="to_org" id="fToOrg" class="form-control" placeholder="เช่น กองยุทธศาสตร์และงบประมาณ">
            </div>
            <div class="col-12">
              <label class="form-label">เรื่อง <span class="text-danger">*</span></label>
              <textarea name="subject" id="fSubject" class="form-control" rows="3" placeholder="เรื่องย่อของหนังสือ" required></textarea>
            </div>
            <div class="col-md-6">
            ...
            <div class="col-md-6">
              ...
              <input type="file" name="attachment" id="fAttachment" class="form-control" accept=".jpg,.jpeg,.png,.gif,.pdf">
...
function openEdit(data) {
  ...
  document.getElementById('modalBookTitle').innerHTML = '<i class="bi bi-pencil-square me-2"></i>แก้ไขหนังสือรับ';
...
function clearFile() {
  ...
  f.method = 'POST';
  f.innerHTML = `<input name="action" value="delete_file"><input name="id" value="${id}">`;
...
document.getElementById('modalBook').addEventListener('hidden.bs.modal', function () {
  ...
  document.getElementById('modalBookTitle').innerHTML = '<i class="bi bi-envelope-plus me-2"></i>เพิ่มหนังสือรับ';
